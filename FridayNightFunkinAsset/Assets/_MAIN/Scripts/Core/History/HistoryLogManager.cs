    ...
    public class HistoryLogManager : MonoBehaviour
    {
        ...
        private void CreateLog(HistoryState state)
        {
            ...
            else
            {
                ...
                log.nameText.font = HistoryCash.LoadFont(state.dialogue.speakerFont);
            ...
            log.dialogueText.font = HistoryCash.LoadFont(state.dialogue.dialogueFont);
        ...
        private void FitLogToText(HistoryLog log)
        {
            ...
            logLayout.preferredHeight += 2f + textScaling;
        }
        ...
        public void SetLogScaling()
        {
            ...
            {
                log.nameText.fontSize = log.nameFontSize + textScaling;
                log.dialogueText.fontSize = log.nameFontSize + textScaling;
